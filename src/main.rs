                    ...
                    if let Some(message_id) = message_id{
                        ...
                        if let Ok(ref_msg) = ref_msg {
                            ...
                            for attachment in ref_msg.attachments{
                                ...
                                if let Ok(mut spoiled_attachment) = CreateAttachment::url(&ctx, &attachment.url).await{
                            ...
                            if let Err(why) = channel_id.send_files(&ctx, attachments, builder).await{
